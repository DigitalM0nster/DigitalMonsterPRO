...
import { getArcDrawableRanges, getArcSegmentOpacity } from "./siteArcOpacity.js";
 ...
 */
export function getNodeArcGlowHighlight(nodeAngleRad, glowCenterAngleRad, cfg, arcGlowStrength, lineCfg = siteArcActiveLineConfig) {
...
export function strokeArcActiveNodeGlow(
	...
	cfg,
	internal,
	lineCfg = siteArcActiveLineConfig,
) {
	if (highlight < 0.01) {
		return;
	}
