...
export class FilmScreen {
 constructor(media,reducedMotion) {
  ...
  this.uniforms={uFrom:{value:media.get(0)},uTo:{value:media.get(0)},uFromAspect:{value:media.aspect(0)},uToAspect:{value:media.aspect(0)},
   ...
   uTime:{value:0},uDpr:{value:1},uLow:{value:getGraphicsTier()==="low"?1:0},uHeaderEnd:{value:-.378}};
 ...
 createMosaic(low){
  ...
  const quad=new THREE.PlaneGeometry(1,1,2,1),geometry=new THREE.InstancedBufferGeometry();
 ...
 dispose(){this.controls.dispose();this.projection.dispose();this.geometry.dispose();this.frameGeometry.dispose();this.hitGeometry.dispose();this.material.dispose();this.frameMaterial.dispose();this.hit.material.dispose();}
}
