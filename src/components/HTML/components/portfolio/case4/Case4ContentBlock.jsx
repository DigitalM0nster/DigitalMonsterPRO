...
import Case4MoreContent from "./Case4MoreContent";
			...
			>
				<div ref={caseStartBlock} className={openedCase === true ? "caseStartBlock active" : "caseStartBlock"}>
					<div className="caseTitleButton">
						...
						<div className="caseTitle">Belka Production</div>
						<div
				...
				<Case4MoreContent openedCase={openedCase} />
			</div>
		</>
	);
}
