...
import Case1MoreContent from "./Case1MoreContent";
...
export default function Case1ContentBlock(props) {
	...
	//   useEffect(() => {
	//     // Функция для обновления windowWidth при изменении размера окна
	//     const handleResize = () => {
			...
			>
				<div ref={caseStartBlock} className={openedCase === true ? "caseStartBlock active" : "caseStartBlock"}>
					<div className="caseTitleButton">
						...
						<div className="caseTitle">НИПИГАЗ</div>
						<div
					...
					<div className="caseType">Разработка сайта к юбилею компании</div>
				...
				<Case1MoreContent openedCase={openedCase} />
			</div>
		</>
	);
}
