...
function resolveRailTrackW() {
	...
	return Math.max(cfg.trackWidthMin, siteArcInternals.trackWidth * cfg.trackWidthMul);
}
...
function resolveRailNodeRadii() {
	...
	const base = resolveNodeMarkerRadii(siteArcInternals, false);
	return {
...
function drawArcStyleNode(ctx, cx, cy, radii, highlight) {
	...
	const trackColor = siteArcInternals.trackColor;
