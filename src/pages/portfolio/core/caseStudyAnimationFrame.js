import { tickArcGlowMotion, isArcGlowAnimating } from "@/components/SiteArc/siteArcGlowMotion.js";
import {
	tickArcNavLabelColors,
	isArcNavLabelColorsAnimating,
} from "@/components/SiteArc/siteArcNavLabelMotion.js";
import {
	isSiteArcShiftAnimating,
	tickSiteArcShift,
} from "@/components/SiteArc/siteArcPositionMotion.js";
import {
	isSiteArcFocusAnimating,
	tickSiteArcFocus,
} from "@/components/SiteArc/siteArcFocusMotion.js";
import {
 ...
 */
export function registerSiteArcPaint(fn) {
	arcPaintCallback = fn;
...
/** @deprecated Используй registerSiteArcPaint */
export function registerCaseStudyPaint(fn) {
	registerSiteArcPaint(fn);
}
...
export function markSiteArcDirty() {
 ...
 */
export function flushSiteArcPaint() {
	if (!arcPaintCallback) {
		return;
	}
	arcPaintCallback();
