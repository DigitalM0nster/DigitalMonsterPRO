...
export const MOBILE_WHALE_URL="/models/home/whale-mobile.glb?v=surface-currents-horizontal-tail-r1";
...
export async function loadMobileWhale(options={}){
 ...
 const depth=createWhaleDepthOccluder(skin);
 ...
 for(let sample=0;sample<12;sample++){
  mixer.setTime((gltf.animations[0]?.duration||0)*sample/12);
