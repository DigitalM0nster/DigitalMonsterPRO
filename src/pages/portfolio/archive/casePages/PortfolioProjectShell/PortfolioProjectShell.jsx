...
import { useProjectState, useInvestigationMode } from "@/pages/portfolio/core/useProjectState.js";
import { useStageProgress } from "@/pages/portfolio/core/useStageProgress.js";
import { usePortfolioStoreBridge } from "@/pages/portfolio/core/usePortfolioStoreBridge.js";
import { useProjectLifecycle } from "@/pages/portfolio/core/useProjectLifecycle.js";
import { useCaseStudyMobileViewport } from "@/pages/portfolio/core/useCaseStudyMobileViewport.js";
import { useSmoothCaseScroll } from "@/pages/portfolio/components/useSmoothCaseScroll.js";
import { buildCaseScrollSnapAnchors } from "@/pages/portfolio/core/caseScrollSnap.js";
import { jumpCaseExperienceToStateIndex, startCaseExperienceRuntime, stopCaseExperienceRuntime } from "@/pages/portfolio/core/caseExperienceRuntime.js";
import { resetStageProgress } from "@/pages/portfolio/core/stageProgress.js";
...
import CaseStudyMobileShell from "@/pages/portfolio/ui/CaseStudyMobile/CaseStudyMobileShell.jsx";
import StateContentOverlay from "@/pages/portfolio/ui/StateContentOverlay/StateContentOverlay.jsx";
import HotspotLayer from "@/pages/portfolio/ui/HotspotLayer/HotspotLayer.jsx";
import styles from "./PortfolioProjectShell.module.scss";

/**
 * @param {{
 *   slug?: string,
 *   project?: import('@/pages/portfolio/core/types.js').PortfolioProjectModule,
...
function PortfolioProjectShellInner({ project, hideArcNavigation, hideProjectNavigation, skipPanelIntro }) {
	// Kept for compatibility with the archived route shell's former public API.
	void hideArcNavigation;
	void skipPanelIntro;
	...
	// Arc chrome lives in SiteArcOverlay (site-level) — not remounted per case.
