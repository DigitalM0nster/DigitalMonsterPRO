const STYLE_MARKER = "sceneDevToolsV7";
...
export function injectSceneDevToolsStyles() {
	...
	style.textContent = `
		...
		.sceneDevTools .fogProfileGrid {
			stroke: rgba(232, 238, 245, 0.14);
			stroke-width: 1;
			vector-effect: non-scaling-stroke;
		}

		.sceneDevTools .fogProfileArea {
			fill: rgba(48, 180, 255, 0.14);
		}

		.sceneDevTools .fogProfileCurve {
			fill: none;
			stroke: #70d9ff;
			stroke-width: 2;
			vector-effect: non-scaling-stroke;
		...
		.sceneDevTools .fogProfileMarker {
			stroke-width: 1;
			stroke-dasharray: 4 3;
			vector-effect: non-scaling-stroke;
		}

		.sceneDevTools .fogProfileMarker.start {
			stroke: #7dffb2;
		}

		.sceneDevTools .fogProfileMarker.end {
			stroke: #ffcf70;
		}

		.sceneDevTools .fogProfileOpacity {
		...
		.sceneDevTools .fogProfileLabel {
			fill: rgba(232, 238, 245, 0.72);
			font: 9px/1 ui-monospace, SFMono-Regular, Menlo, Consolas, monospace;
		}

		.sceneDevTools .fogProfileLabel.start {
			fill: #7dffb2;
		}

		.sceneDevTools .fogProfileLabel.end {
			fill: #ffcf70;
		}
	`;
