import { siteMainRgba } from "@/app/config/siteMainColor.js";
import { getArcLineStrokeStyle } from "./siteArcConfig.js";
import {
	siteArcTrailLineConfig,
	getTrailNodeBloomAlpha,
} from "./siteArcTrailLineConfig.js";
import { getDrawableArcProgressToAngle, strokeArcProgressFaded } from "./siteArcOpacity.js";
 ...
 * @param {typeof siteArcTrailLineConfig} [trailCfg]
 */
export function strokeArcTrailToGlow(
	...
	cutoutHalfRad,
	fadeBounds,
	trailCfg = siteArcTrailLineConfig,
) {
